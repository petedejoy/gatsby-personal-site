...
In last quarter’s 10-Q statement, Mongo claimed $130M in total revenue. If I’m crunching the numbers correctly, that suggests that Atlas had done almost $55M revenue, up from $2.1M at the time of their IPO. Additionally, they claimed on their Q4 2020 earnings call (MongoDB Inc has a weird fiscal year that ends on January 31st) that they had over 15,400 customers on Atlas, up from 1900 at the time of the IPO. Just three years was all it took for over 25x revenue growth and 8x customer count.
...
An interesting recent development is that Mongo is focusing on expanding Atlas further to be significantly more expansive than attractive deployment service for the core open-source MongoDB Community Server; they’re taking a fully-integrated approach and building a BI layer, data layer, and data export layer as a strategic move to bring Atlas up the data stack. 
