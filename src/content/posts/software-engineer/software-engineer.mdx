...
import css-win from './images/css-win.png'
import discouraging from './images/discouraging.png'
import network-success from './images/network-success.png'
...
<img src={css-win} alt="CSS Win" className="row" />

<img src={network-success} alt="Network Success" className="row" />
