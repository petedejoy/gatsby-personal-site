...
<p>
Whereas desperation lit the flame, a collection of other factors kept it burning increasingly brightly over the year that followed. I chose to use [Stripe](https://stripe.com) as our payment integration tool, as their API is extremely well-documented and they had open-sourced a ton of example code that&nbsp;
<div class="tooltip">
      I could leverage.
    <div class="top">
...
<div class="tooltip">
      most valuable&nbsp;
    <div class="top">
        <p> "Value" here is used to describe ROI per dollar spent learning.</p>
        <i></i>
    </div>
</div>
